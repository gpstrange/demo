...
import { PptNavigationItem, PptNavigationService, PptVerticalNavigationComponent } from '@ppt/components/navigation';
...
export class MailboxSidebarComponent implements OnInit, OnDestroy
{
    ...
    private _filtersMenuData: PptNavigationItem[] = [];
    private _foldersMenuData: PptNavigationItem[] = [];
    private _labelsMenuData: PptNavigationItem[] = [];
    private _otherMenuData: PptNavigationItem[] = [];
    ...
    private _generateFoldersMenuLinks(): void
    {
        ...
        this.folders.forEach((folder) => {
            ...
            const menuItem: PptNavigationItem = {
                id   : folder.id,
                title: folder.title,
                type : 'basic',
                icon : folder.icon,
    ...
    private _updateNavigationBadge(folders: MailFolder[]): void
    {
        ...
        const mainNavigationComponent = this._pptNavigationService.getComponent<PptVerticalNavigationComponent>('mainNavigation');

        // If the main navigation component exists...
        if ( mainNavigationComponent )
        {
            const mainNavigation = mainNavigationComponent.navigation;
            const menuItem = this._pptNavigationService.getItem('apps.mailbox', mainNavigation);
