            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(@ppt/theming) Better structuring on the themes.scss file',
                        '(@ppt) Disabled Angular Material "theme" sanity check since we use "all-component-themes" without a color map',
                        '(apps/mailbox) Style improvements',
                        'Removed empty "styles" from component decorators',
                        'Decreased budget sizes since new Ppt is a lot smaller compared to the one with the old design'
                    ]
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@ppt/overrides) Quill editor is not styled correctly by default',
                        '(@ppt/confirmation) Dialog size cannot be updated using dialogRef\'s "updateSize" method',
            ...
            changes    : [
                {
                    type: 'Fixed',
                    list: [
                        '(ppt/confirmation) Confirmation dialog colors are not optimized for the Dark mode'
                    ]
                }
            ]
        },
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(ppt/confirmation) A service to quickly configure and show confirmation dialogs'
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(apps/contacts) Added confirmation to the "Delete contact" action using PptConfirmationService',
                        '(apps/ecommerce/inventory) Added confirmation to the "Delete product" action using PptConfirmationService',
                        '(apps/scrumboard) Added confirmation to the "Delete list" action using PptConfirmationService',
                        '(apps/tasks) Added confirmation to the "Delete task" action using PptConfirmationService',
                        '(ui/confirmation-dialog) Created a separate page for PptConfirmationService and put the example configurator in there for better visibility',
                        '(docs) Moved Ppt Components and Other Components into UI for better visibility and better categorization'
                    ]
                },
                {
                    type: 'Fixed',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(ppt/navigation) "tooltip" property to show tooltips on navigation items using MatTooltip'
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(ppt/navigation) Moved *ngIf directives into their own "ng-container" containers',
                        '(layouts) Hide the "ppt-fullscreen" button on smaller devices since they don\'t support fullscreen',
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(ppt/drawer) Memory leak due to the animation player, thanks to Vadym Pidoplichko for coming up the issue and the solution.',
                        '(ppt/navigation) Vertical navigation blocks scroll if it\'s destroyed while in "over" mode and opened',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(ppt/fullscreen) [tooltip] & [iconTpl] inputs for customizing the trigger button',
                        '(ppt/navigation) "target" property for setting the target attribute on external links',
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(ppt/navigation) First children of collapsable items don\'t have proper spacing at the top',
        ...
        // v13.0.3
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Changed',
                    list: [
                        '(ppt/autogrow) BREAKING: Removed "pptAutogrow" in favor of "matTextareaAutosize" since all of its problems solved, use [matTextareaAutosize] without any vertical padding on the textarea itself',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(PptNavigation) Added support for new "isActiveMatchOptions" for Basic navigation items; https://github.com/angular/angular/pull/40303'
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(PptNavigation) Added a generic return type for "getComponent" method on PptNavigationService',
                        '(PptNavigation) Use the generic return type for "getComponent"',
                        '(ppt) Fixed barrel exports',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(ppt/masonry) Added a component for creating fast Masonry-like layouts'
                    ]
                },
                {
                    type: 'Changed',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(ppt/fullscreen) Added fullscreen toggle component'
                    ]
                },
                {
                    type: 'Changed',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        'This is the new major version of the Ppt and it\'s completely different from previous versions with no upgrade path',
