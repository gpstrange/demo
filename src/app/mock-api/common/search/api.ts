...
import { PptNavigationItem, PptNavigationService } from '@ppt/components/navigation';
...
export class SearchMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        const flatNavigation = this._pptNavigationService.getFlatNavigation(this._defaultNavigation);
