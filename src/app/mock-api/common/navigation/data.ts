...
export const defaultNavigation: PptNavigationItem[] = [
    {
        id      : 'dashboards',
        title   : 'Dashboards',
    ...
    },
    {
        ...
        children: [
            ...
            {
                id   : 'user-interface.ppt-components',
                title: 'Ppt Components',
                type : 'basic',
                icon : 'heroicons_outline:chip',
                link : '/ui/ppt-components'
            },
            {
    ...
    },
    {
        id      : 'documentation',
        title   : 'Documentation',
        subtitle: 'Everything you need to know about Ppt',
        type    : 'group',
        icon    : 'heroicons_outline:support',
        children: [
            {
...
export const compactNavigation: PptNavigationItem[] = [
    {
        id      : 'dashboards',
        title   : 'Dashboards',
        tooltip : 'Dashboards',
...
export const futuristicNavigation: PptNavigationItem[] = [
    {
        id      : 'dashboards',
        title   : 'DASHBOARDS',
        type    : 'group',
...
export const horizontalNavigation: PptNavigationItem[] = [
    {
        id      : 'dashboards',
        title   : 'Dashboards',
        type    : 'group',
