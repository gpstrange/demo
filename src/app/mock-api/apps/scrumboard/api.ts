...
import { PptMockApiService, PptMockApiUtils } from '@ppt/lib/mock-api';
    ...
    registerHandlers(): void
    {
        ...
        this._pptMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newList.id = PptMockApiUtils.guid();
        ...
        this._pptMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newCard.id = PptMockApiUtils.guid();
        ...
        this._pptMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newLabel.id = PptMockApiUtils.guid();
