...
import { FSDocument, FSDocumentElement } from '@ppt/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'ppt-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'pptFullscreen'
})
export class PptFullscreenComponent implements OnInit
{
