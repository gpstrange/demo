...
@Component({
    selector     : 'ppt-date-range',
    templateUrl  : './date-range.component.html',
    styleUrls    : ['./date-range.component.scss'],
    encapsulation: ViewEncapsulation.None,
    exportAs     : 'pptDateRange',
    providers    : [
        {
            provide    : NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => PptDateRangeComponent),
            multi      : true
        }
    ]
})
export class PptDateRangeComponent implements ControlValueAccessor, OnInit, OnDestroy
{
    ...
    @HostBinding('class.ppt-date-range') private _defaultClassNames = true;
    ...
    openPickerPanel(): void
    {
        ...
        const overlayRef = this._overlay.create({
            panelClass      : 'ppt-date-range-panel',
            backdropClass   : '',
            hasBackdrop     : true,
