...
import { PptHighlightService } from '@ppt/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[ppt-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'pptHighlight'
})
export class PptHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _pptHighlightService: PptHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._pptHighlightService.highlight(this.code, this.lang));
