...
import { PptMockApiReplyCallback } from '@ppt/lib/mock-api/mock-api.types';

export class PptMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: PptMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: PptMockApiReplyCallback): void
    {
        // Store the reply
