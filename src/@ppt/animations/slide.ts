...
import { PptAnimationCurves, PptAnimationDurations } from '@ppt/animations/defaults';
...
const slideInTop = trigger('slideInTop',
    [
        ...
        transition('void => *', animate('{{timings}}'),
            {
                params: {
                    timings: `${PptAnimationDurations.entering} ${PptAnimationCurves.deceleration}`
                }
            }
        )
    ]
...
const slideOutTop = trigger('slideOutTop',
    [
        ...
        transition('* => void', animate('{{timings}}'),
            {
                params: {
                    timings: `${PptAnimationDurations.exiting} ${PptAnimationCurves.acceleration}`
                }
            }
        )
    ]
