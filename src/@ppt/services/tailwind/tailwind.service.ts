...
import * as extractedTailwindConfigStyle from '@ppt/styles/core/tailwind-config.scss';

@Injectable()
export class PptTailwindService
{
    ...
    constructor()
    {
        ...
        const regexpForClass = /\.ppt-tailwind-extracted-config\s\{([\s\S]*)\}/g;
