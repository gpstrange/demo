...
const generatePalette = require(path.resolve(__dirname, ('src/@ppt/tailwind/utils/generate-palette')));
...
const config = {
            ...
            typography: (theme) => ({
                DEFAULT: {
                    css: {
                        ...
                        'ul > li::before'  : {
                            backgroundColor: 'var(--ppt-text-hint)'
                        },
                        hr                 : {
                            borderColor: 'var(--ppt-border)'
                        },
                        blockquote         : {
                            color          : 'var(--ppt-text-default)',
                            borderLeftColor: 'var(--ppt-border)'
                        },
                        h1                 : {
                            color: 'var(--ppt-text-default)'
                        },
                        ...
                        thead              : {
                            color            : 'var(--ppt-text-default)',
                            borderBottomColor: 'var(--ppt-border)'
                        },
                        'tbody tr'         : {
                            borderBottomColor: 'var(--ppt-border)'
                        },
    ...
    plugins     : [
        ...
        // Ppt - Tailwind plugins
        require(path.resolve(__dirname, ('src/@ppt/tailwind/plugins/extract-config'))),
        require(path.resolve(__dirname, ('src/@ppt/tailwind/plugins/utilities'))),
        require(path.resolve(__dirname, ('src/@ppt/tailwind/plugins/icon-size'))),
        require(path.resolve(__dirname, ('src/@ppt/tailwind/plugins/theming')))({themes}),
